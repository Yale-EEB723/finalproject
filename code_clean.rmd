...
To pull out the longest sequences from your fasta file, use fasta_puller.py. Fasta_puller.py requires that the names in the list exactly match the names in the fasta (including the '>'). This means that you have to Regex the names in the list.
