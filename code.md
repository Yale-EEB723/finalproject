...
The code above produces a list of all of the longest peptide per gene. Use the below Python script I wrote to pull out each sequence in the list. The fasta headers in this list must perfectly match those in the fasta file.  
