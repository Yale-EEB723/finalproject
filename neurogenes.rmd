...
mrca <-getMRCA(phy,as.character(homolog.animals$animal))%>%rep(.,nrow(homolog.animals))
h.repeat<-rep(h,nrow(homolog.animals))
homolog.animal.df<-cbind(homolog.animals,h.repeat,mrca)
result<-rbind(result,homolog.animal.df)
