...
analysis.table.reference<-filter(cluster.master.table,animal==reference|animal==comparison)
...
-cluster = scaffolds
-ref gene scaffold
  -for each comparison scaffold that shares cluster_id
    -determine homology_ids present in ref gene scaffold but not comparison scaffold
